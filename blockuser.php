...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color:#3d97b9;">Blocked Customer </h1>
                  ...
                  <table class="table table-borderless datatable mt-2" id="data-table">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sql = "SELECT * FROM customer WHERE status ='Blocked'";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><button class='btn btn-sm' style='background-color:#1f9acd;color:white;' data-bs-toggle='modal' data-bs-target='#sus".$row['id']."'>Unblocked</button>
...
echo "<div class='modal fade' id='sus".$row['id']."' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                      <div class='modal-dialog'>
                                        <div class='modal-content'>
                                          ...
                                          <form action='unblockedcustomer.php' method='post'>
                                          <input type='hidden' name='id' value='".$row['id']."'>
                                          <center><img src='sus.png' width='100px'></center>
                                          <center><h5>Are you sure you want to Unblocked this customer?</h5></center>
                                          </div>
                                          <div class='modal-footer'>
                                            <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Close</button>
                                            <button type='submit' class='btn' style='background-color:#1f9acd;color:white;'>Unblocked</button>
                                            </form>
                                          </div>
                                        </div>
                                      </div>
