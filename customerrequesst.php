...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color:#3d97b9;">Requests  </h1>
  ...
  <tbody>
    ...
    $id = $_SESSION['id'];
      $sql = "SELECT r.id, r.customer,
       ...
       WHERE r.customer = '$id'  AND r.status != 'Reported' AND r.status != 'Completed'
       GROUP BY r.id";
      ...
      if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              if($row['status']=="Cancel"){
                echo "<td>";
                echo "<button  class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#report".$row['id']."'>Report</button>";
                 echo "<div class='modal fade' id='report".$row['id']."' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                      ...
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                          ...
                          <input type='hidden' name='car' value='".$row['carwash']."'>
                           ...
                           <input type='hidden' name='cancel' value='".$row['cancelationtime']."'>

                          <div class='form-floating'>
                            <textarea class='form-control' placeholder='Leave a comment here' name='text' id='floatingTextarea2' style='height: 100px'></textarea>
                ...
                echo "<td>";
              echo "<a href='edit_request.php?id=" . htmlspecialchars($row['customer']) . "' class='btn btn-primary btn-sm'>Edit</a> ";
              echo "<button  class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#exampleModal".$row['id']."'>Cancel</button>";
