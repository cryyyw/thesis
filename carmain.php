  ...
  <div class="row">
         ...
         <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      $id = $_SESSION['id'];
                      $sql = "select count(id) as count from request where carwash = '$id' and status= 'Pending'";
    ...
    <div class="col-xxl-3 col-md-6">
      ...
      <div class="card info-card ">
         ...
         <div class="card-body">
                  <h5 class="card-title">No. of Complaint </h5>
    ...
    <div class="col-xxl-3 col-md-6">
      ...
      <div class="card info-card ">
         <div class="card-body">
                  <h5 class="card-title">Total Earn</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      $id = $_SESSION['id'];
                      $sql = "select sum(total) as count from request where carwash = '$id' and status = 'Completed'";
                      $result = mysqli_query($conn, $sql);
                      while ($row = mysqli_fetch_array($result)) {
                        echo "<tr>";
                        echo $row['count'];
