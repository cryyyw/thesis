...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="color:#3d97b9;">Customer </h1>
                  ...
                  <table class="table table-borderless datatable mt-2" id="data-table">
                    ...
                    <tbody>
                      <?php
                        ...
                        $sql = "SELECT * FROM customer WHERE status ='Accepted'";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><button class='btn btn-sm' style='background-color:#1f9acd;color:white;' data-bs-toggle='modal' data-bs-target='#sus".$row['id']."'>Block</button>
...
echo "<div class='modal fade' id='sus".$row['id']."' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                      <div class='modal-dialog'>
                                        <div class='modal-content'>
                                          ...
                                          <form action='suspendcustomer.php' method='post'>
